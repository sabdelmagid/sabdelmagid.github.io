...
const css = {
	code: ".footer.svelte-qm5faf{position:fixed;left:0;bottom:0;width:100%;background-color:rgb(0, 0, 0);color:white;text-align:center}.color-gradient.svelte-qm5faf{background-image:linear-gradient(-225deg, #66c2a5 0%, #fc8d62 29%, #8da0cb 67%, #e78ac3 100%);background-size:200% auto;color:#fff;background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:svelte-qm5faf-textclip 5s linear infinite;display:inline-block}@keyframes svelte-qm5faf-textclip{to{background-position:200% center}}.content.svelte-qm5faf{display:flex;flex-direction:column;flex:1;padding:10px 0px}.container.svelte-qm5faf{max-width:1200px;min-width:1200px;margin:0px auto}@media(max-width: 1350px){.container.svelte-qm5faf{max-width:1000px;min-width:1000px}}@media(max-width: 1075px){.container.svelte-qm5faf{max-width:-webkit-fill-available;min-width:-webkit-fill-available;max-width:-moz-available;min-width:-moz-available}}@media(max-width: 950px){.content.svelte-qm5faf{padding-left:15px;padding-right:15px}}@media(max-width: 750px){.content.svelte-qm5faf{padding-left:10px;padding-right:10px}}body{margin:0px;background-color:var(--primary-c);color:var(--primary-text-c);font-family:var(--text-f);display:flex;flex-direction:column;letter-spacing:1px;min-height:100vh}p{margin:0px}h1, h2, h3, h4, h5, h6{margin:5px 0px}",
	map: null
};
...
<div class="content container svelte-qm5faf">${slots.default ? slots.default({}) : ``}</div>
<div class="footer svelte-qm5faf"><h3 class="color-gradient svelte-qm5faf">© 2023 Simon Warchol</h3>
</div>`;
});
